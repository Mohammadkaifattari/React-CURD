...
const App = () => {
  ...
  return (
    <div className='h-screen   bg-black text-white lg:flex   '>
      ...
      <div className=' p-10  lg:w-1/2 border-l scrollbar-hide overflow-auto bg relative bg-black'>
        <h1 className='text-2xl font-bold'>Recent Notes</h1>
        <div className=' flex flex-wrap justify-around gap-7  h-full scrollbar-hide overflow-auto '>
          {note.map((e, idx) => {
            return <div
              key={idx}
  ...
  overflow-auto"
            >
              <h1 className='text-2xl font-bold   mt-1 '>{e.title}</h1>
